...
const PracticeSuitScreen = ({ onBack }) => {
  const [items, setItems] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    fetch(`${API_CONFIG.BASE_URL}/practice-suit`)
      .then(r => r.json())
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Practice suit (Do Bok)</Text>
        <View style={{ width: 40 }} />
      </View>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    backgroundColor: '#006CB5', paddingHorizontal: spacing.md, paddingVertical: spacing.md,
...
export default PracticeSuitScreen;
