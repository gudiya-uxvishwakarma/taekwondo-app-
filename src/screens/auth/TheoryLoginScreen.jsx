...
const TheoryLoginScreen = ({ onBack, onLoginSuccess, onPaymentRequired }) => {
  ...
  const handleOtpLogin = async () => {
    ...
    try {
      ...
      if (response?.status === 'success' && response?.data?.token) {
        ...
        await AsyncStorage.setItem('loginSource', 'theory');
        await login({ _otpLoginData: response.data });
        Alert.alert('Success', 'Login successful! Welcome to Theory Syllabus', [
  ...
  const handleNeedRegistration = () => {
    Alert.alert(
      'Not Registered?',
      'To access the Theory Syllabus, you need to register as a student and complete the payment.',
      [
      ...
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView ref={scrollRef} contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false} bounces={false} keyboardShouldPersistTaps="handled">
          ...
          <Animated.View style={[styles.logoSection, { opacity: fadeAnim, transform: [{ scale: logoScale }, { translateY: slideAnim }] }]}>
            ...
            <Text style={styles.welcomeTitle}>Theory Syllabus</Text>
            <Text style={styles.welcomeSubtitle}>Login to access your theory training content</Text>
          </Animated.View>
          ...
          <Animated.View style={[styles.formContainer, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            ...
            <View style={styles.infoBox}>
              ...
              <Text style={styles.infoText}>
                Only registered students can access the Theory Syllabus
              </Text>
            </View>
          </Animated.View>
        </ScrollView>
