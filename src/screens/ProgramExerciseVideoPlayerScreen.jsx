    ...
    <View style={styles.safeArea}>
      ...
      <ScrollView style={styles.thumbList} showsVerticalScrollIndicator={false}>
        {exercises.map((ex, idx) => (
          ...
          >
            {ex.image ? (
              <ImageBackground source={getImageSource(ex.image)} style={styles.thumbImg} imageStyle={{ borderRadius: 10 }}>
              ...
              <View style={[styles.thumbImg, styles.thumbImgEmpty]}>
                <Icon name="fitness-center" size={20} color="#9ca3af" type="MaterialIcons" />
              </View>
            )}
            <Text
...
const styles = StyleSheet.create({
  ...
  thumbImgEmpty: { backgroundColor: '#e5e7eb' },
