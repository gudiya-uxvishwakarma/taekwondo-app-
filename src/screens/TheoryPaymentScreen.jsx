...
const FEATURES = [
  { icon: 'menu-book',       label: 'Full Theory',        desc: 'All belt levels covered'     },
  { icon: 'translate',       label: 'Korean Terms',        desc: '300+ words & commands'       },
  { icon: 'emoji-events',    label: 'Grading Guide',       desc: 'Exam prep & tips'            },
  { icon: 'question-answer', label: 'Theory Questions',    desc: 'Practice Q&A for exams'      },
];

const TheoryPaymentScreen = ({ onBack, onPaymentSuccess }) => {
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <Animated.View style={[styles.hero, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
          ...
          <Text style={styles.heroTitle}>Theory Syllabus</Text>
          <Text style={styles.heroSub}>Everything you need to master Taekwon-Do theory</Text>
        ...
        >
          {loading ? (
            ...
            <>
              ...
              <Text style={styles.payText}>Pay ₹299 & Get Access</Text>
            </>
          )}
        </TouchableOpacity>
...
export default TheoryPaymentScreen;
